        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NamePosition = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeCargo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoundationId = table.Column<long>(type: "bigint", nullable: false),
                    FreightAMount = table.Column<double>(type: "float", nullable: false),
                    CurrencyId = table.Column<long>(type: "bigint", nullable: false),
                    DateToLoad = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DateToUnload = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ActAccNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bids_Cars_CarsId",
                        column: x => x.CarsId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bids_Currencies_CurrencyId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bids_Foundation_FoundationId",
                        column: x => x.FoundationId,
                        principalTable: "Foundation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bids_Status_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightCargo = table.Column<double>(type: "float", nullable: false),
                    TypeCargoId = table.Column<long>(type: "bigint", nullable: false),
                    BidsId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cargo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cargo_Bids_BidsId",
                        column: x => x.BidsId,
                        principalTable: "Bids",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cargo_TypeCargo_TypeCargoId",
                        column: x => x.TypeCargoId,
                        principalTable: "TypeCargo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameExpense = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Amount = table.Column<double>(type: "float", nullable: false),
                    CurrencyId = table.Column<long>(type: "bigint", nullable: false),
                    DateTransfer = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PointA = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    PointB = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    BidsId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cargo_BidsId",
                table: "Cargo",
                column: "BidsId");

            migrationBuilder.CreateIndex(
                name: "IX_Cargo_TypeCargoId",
                table: "Cargo",
                column: "TypeCargoId");
